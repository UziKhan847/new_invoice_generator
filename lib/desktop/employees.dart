...
/// Employees, promoted to a top-level desktop section (was buried in
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        const DesktopTopBar(
          title: 'Employees',
          subtitle: 'People you can assign as an invoice sender',
        ),
        Expanded(
          child: Padding(
            ...
            child: DecoratedBox(
              ...
              child: ClipRRect(
                borderRadius: radius,
                child: const EmbeddedMobileSection(child: EmployeesScreen()),
              ),
            ),
          ),
        ),
